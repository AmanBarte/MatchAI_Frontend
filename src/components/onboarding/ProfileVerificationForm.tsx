  ...
  return (
    <div className="w-full max-w-2xl mx-auto flex flex-col items-center">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-500 dark:text-slate-400 font-inter">We've extracted info from your resume. Please verify and fill in the missing required fields.</p>
      </div>
