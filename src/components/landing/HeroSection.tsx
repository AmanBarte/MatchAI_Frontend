...
export default function HeroSection({ onGetStarted }: HeroSectionProps) {
  ...
  const headingText = "Less Hassle, More Interviews.";
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center bg-transparent pt-32 pb-48 px-6 sm:px-10 z-20">
      ...
      <div className="max-w-5xl mx-auto w-full flex flex-col items-center text-center relative z-20">
        ...
        >
          Stop endlessly tailoring your resume. Let our AI analyze the job description and instantly optimize your application for the highest recruiter match rate.
        </motion.p>
      ...
      >
        ...
        <div className="flex flex-col text-center md:text-left">
            <h3 className="font-inter font-bold text-[1.25rem] text-on-surface">Excellent Match Score</h3>
            <p className="font-inter text-[0.875rem] text-on-surface-variant mt-2 leading-relaxed">
              Based on the Job Description, your background aligns perfectly with the Core Requirements of the <strong>Frontend Architect</strong> role.
            </p>
        </div>
      </motion.div>
    </section>
