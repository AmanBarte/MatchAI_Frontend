        ...
        <header className="fixed top-0 left-0 w-full z-[9999] flex justify-between items-center px-6 sm:px-10 py-4 backdrop-blur-md bg-transparent transition-colors duration-300">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => setCurrentView('landing')}>
            <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center shadow-sm">
               <span className="text-white font-bold font-inter text-[1rem]">M</span>
            </div>
            <span className="font-inter font-extrabold text-[1.25rem] tracking-tight text-slate-900 dark:text-white transition-colors duration-300">MatchAI</span>
          </div>
